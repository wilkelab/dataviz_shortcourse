...
.absolute-bottom-right.tiny-font[
California House Price Index (HPI). Source: Freddie Mac.
]
...
## Exponential versus linear detrending
...
Any type of growth process (increase is proportional to present value) **must** be analyzed in log space

---

## Example: HPI analysis in linear space does looks off
...
## Detrending in linear space creates systematic deviations
...
## Detrended in log-space one more time for comparison
...
## We can decompose into:<br> long-term trend, seasonal effect, remainder (noise)
...
.small-font[
Magnitude of remainder should be small compared to that of seasonal fluctuations
]
